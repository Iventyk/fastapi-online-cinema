...
def upgrade() -> None:
    ...
    with op.batch_alter_table('movies', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_movies_imdb'), ['imdb'], unique=False)
    ...
    sa.UniqueConstraint('user_id', name='unique_activation_token_for_user')
    )
    ...
    with op.batch_alter_table('payment_items', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_payment_items_order_item_id'), ['order_item_id'], unique=False)
